...
pub fn build(b: *std.Build) void {
    ...
    // const mod = b.addModule("create_dataset", .{
    ...
    // });
    //
    const traces = b.addModule("traces", .{
        .root_source_file = b.path("../bskysim/src/traces.zig"),
        .target = target,
    });
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "create_dataset" is the name you will use in your source code to
                // import this module (e.g. `@import("create_dataset")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "traces", .module = traces },
            },
        }),
    });
